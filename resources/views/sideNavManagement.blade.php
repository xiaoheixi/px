    ...
    <div class='container-fluid'>
        <div class="row">
            ...
            <div class="col-md-9 col-xs-12 ">
                ...
                <hr />
                <div align="right">
                    <a href="{{url('createSideNav')}}" class="btn btn-info">Add Side Navigation Bar Option</a>
                </div>
                <hr />
                <table style="width:100%">
                    ...
                    <tr>
                        ...
                        <td><a href="/sideNav/{{ $side_nav->sideNavName }}/edit" class="btn btn-primary">Modify</a></td>
                        <td>
